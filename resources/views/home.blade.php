    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <header class="bg-white shadow">
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                ...
                <nav>
                    <a href="/cardapio" class="text-gray-700 hover:text-orange-600 mx-4">Cardápio</a>
        ...
        <section class="bg-cover bg-center h-96" style="background-image: url('https://images.unsplash.com/photo-1600891964599-f61ba0e24092');">
            <div class="bg-black bg-opacity-50 h-full flex items-center justify-center">
                <div class="text-center text-white">
                    ...
                    <a href="/cardapio" class="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded-full text-lg">Ver Cardápio</a>
                </div>
            </div>
        </section>
        ...
        <footer class="bg-white shadow py-4 text-center text-gray-500">
            &copy; {{ date('Y') }} Mauá Restaurante. Todos os direitos reservados.
        </footer>
    </div>
@endsection
